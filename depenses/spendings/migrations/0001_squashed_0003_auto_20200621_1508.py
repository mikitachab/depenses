...
class Migration(migrations.Migration):
    ...
    replaces = [('spendings', '0001_initial'), ('spendings', '0002_auto_20200621_1504'), ('spendings', '0003_auto_20200621_1508')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users', models.ManyToManyField(through='spendings.Member', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='member',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='spendings.Member')),
            ],
        ),
    ]
